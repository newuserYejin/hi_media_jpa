...
public class Member {
    ...
    length : 뮨자열 길이 String 타입만 사용(기본 255)
     */
    ...
    @Column(name = "memder_id", nullable = false, unique = true, columnDefinition = "varchar(10)")
    ...
    * - 장점 : 가족성이 좋으며 , 이름으로 저장하기 때문에 순서 변경 지장 없음
    * - 단점 : 데이터 크기가 숫자일때보다 크다.
    * */
